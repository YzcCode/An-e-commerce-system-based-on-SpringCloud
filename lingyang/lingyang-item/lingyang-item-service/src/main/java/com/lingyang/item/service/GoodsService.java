...
import com.lingyang.item.mapper.*;
...
public class GoodsService {
    ...
    public void deleteSpu(Long spuId) {
        this.spuMapper.deleteSpu(spuId);
        sendMsg("delete", spuId);
    }

    public void isSaleable(Long spuId, Boolean saleable) {
        int isSaleable = 0;
        if(saleable == false){
            isSaleable = 1;
        ...
        this.spuMapper.isSaleable(spuId, isSaleable);
    }
}
